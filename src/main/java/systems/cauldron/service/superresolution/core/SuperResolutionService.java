...
public class SuperResolutionService implements AutoCloseable {

    private final static Logger LOG = LogManager.getLogger(SuperResolutionService.class);
    ...
    public SuperResolutionService(Path modelPath, int scalingFactor) throws OrtException {
